...
class Logger(_Singleton, _BasicLogger):
	...
	def _ansi_color_set_init(self):
		...
		"""
		self.__AnsiColorSet['DEBUG_TIME'] = AnsiColor(GetDefaultColor(8), "foreground")
		self.__AnsiColorSet['DEBUG_USER'] = AnsiColor(GetDefaultColor(7), "foreground")
		self.__AnsiColorSet['DEBUG_STATUS'] = AnsiColor(GetDefaultColor(4), "foreground")
		self.__AnsiColorSet['DEBUG_STATUS_MESSAGE'] = AnsiColor(GetDefaultColor(3), "foreground")
		self.__AnsiColorSet['TYPE_DEBUG'] = AnsiColor(GetDefaultColor(28), "foreground")
		self.__AnsiColorSet['DEBUG_MESSAGE'] = AnsiColor(GetDefaultColor(27), "foreground")
		self.__AnsiColorSet['DEBUG_BACKGROUND'] = ""

		self.__AnsiColorSet['DEBUG_PERFORMANCE_TIME'] = AnsiColor(GetDefaultColor(8), "foreground")
		self.__AnsiColorSet['DEBUG_PERFORMANCE_USER'] = AnsiColor(GetDefaultColor(7), "foreground")
		self.__AnsiColorSet['DEBUG_PERFORMANCE_STATUS'] = AnsiColor(GetDefaultColor(4), "foreground")
		self.__AnsiColorSet['DEBUG_PERFORMANCE_STATUS_MESSAGE'] = AnsiColor(GetDefaultColor(3), "foreground")
		self.__AnsiColorSet['TYPE_DEBUG_PERFORMANCE'] = AnsiColor(GetDefaultColor(30), "foreground")
		self.__AnsiColorSet['DEBUG_PERFORMANCE_MESSAGE'] = AnsiColor(GetDefaultColor(29), "foreground")
		self.__AnsiColorSet['DEBUG_PERFORMANCE_BACKGROUND'] = ""

		self.__AnsiColorSet['PERFORMANCE_TIME'] = AnsiColor(GetDefaultColor(8), "foreground")
		self.__AnsiColorSet['PERFORMANCE_USER'] = AnsiColor(GetDefaultColor(7), "foreground")
		self.__AnsiColorSet['PERFORMANCE_STATUS'] = AnsiColor(GetDefaultColor(4), "foreground")
		self.__AnsiColorSet['PERFORMANCE_STATUS_MESSAGE'] = AnsiColor(GetDefaultColor(3), "foreground")
		self.__AnsiColorSet['TYPE_PERFORMANCE'] = AnsiColor(GetDefaultColor(32), "foreground")
		self.__AnsiColorSet['PERFORMANCE_MESSAGE'] = AnsiColor(GetDefaultColor(31), "foreground")
		self.__AnsiColorSet['PERFORMANCE_BACKGROUND'] = ""

		self.__AnsiColorSet['EVENT_TIME'] = AnsiColor(GetDefaultColor(8), "foreground")
		self.__AnsiColorSet['EVENT_USER'] = AnsiColor(GetDefaultColor(7), "foreground")
		self.__AnsiColorSet['EVENT_STATUS'] = AnsiColor(GetDefaultColor(4), "foreground")
		self.__AnsiColorSet['EVENT_STATUS_MESSAGE'] = AnsiColor(GetDefaultColor(3), "foreground")
		self.__AnsiColorSet['TYPE_EVENT'] = AnsiColor(GetDefaultColor(15), "foreground")
		self.__AnsiColorSet['EVENT_MESSAGE'] = AnsiColor(GetDefaultColor(12), "foreground")
		self.__AnsiColorSet['EVENT_BACKGROUND'] = ""

		self.__AnsiColorSet['AUDIT_TIME'] = AnsiColor(GetDefaultColor(8), "foreground")
		self.__AnsiColorSet['AUDIT_USER'] = AnsiColor(GetDefaultColor(7), "foreground")
		self.__AnsiColorSet['AUDIT_STATUS'] = AnsiColor(GetDefaultColor(4), "foreground")
		self.__AnsiColorSet['AUDIT_STATUS_MESSAGE'] = AnsiColor(GetDefaultColor(3), "foreground")
		self.__AnsiColorSet['TYPE_AUDIT'] = AnsiColor(GetDefaultColor(16), "foreground")
		self.__AnsiColorSet['AUDIT_MESSAGE'] = AnsiColor(GetDefaultColor(14), "foreground")
		self.__AnsiColorSet['AUDIT_BACKGROUND'] = ""

		self.__AnsiColorSet['METRICS_TIME'] = AnsiColor(GetDefaultColor(8), "foreground")
		self.__AnsiColorSet['METRICS_USER'] = AnsiColor(GetDefaultColor(7), "foreground")
		self.__AnsiColorSet['METRICS_STATUS'] = AnsiColor(GetDefaultColor(4), "foreground")
		self.__AnsiColorSet['METRICS_STATUS_MESSAGE'] = AnsiColor(GetDefaultColor(3), "foreground")
		self.__AnsiColorSet['TYPE_METRICS'] = AnsiColor(GetDefaultColor(13), "foreground")
		self.__AnsiColorSet['METRICS_MESSAGE'] = AnsiColor(GetDefaultColor(11), "foreground")
		self.__AnsiColorSet['METRICS_BACKGROUND'] = ""

		self.__AnsiColorSet['USER_TIME'] = AnsiColor(GetDefaultColor(8), "foreground")
		self.__AnsiColorSet['USER_USER'] = AnsiColor(GetDefaultColor(7), "foreground")
		self.__AnsiColorSet['USER_STATUS'] = AnsiColor(GetDefaultColor(4), "foreground")
		self.__AnsiColorSet['USER_STATUS_MESSAGE'] = AnsiColor(GetDefaultColor(3), "foreground")
		self.__AnsiColorSet['TYPE_USER'] = AnsiColor(GetDefaultColor(18), "foreground")
		self.__AnsiColorSet['USER_MESSAGE'] = AnsiColor(GetDefaultColor(17), "foreground")
		self.__AnsiColorSet['USER_BACKGROUND'] = ""

		self.__AnsiColorSet['MESSAGE_TIME'] = AnsiColor(GetDefaultColor(8), "foreground")
		self.__AnsiColorSet['MESSAGE_USER'] = AnsiColor(GetDefaultColor(7), "foreground")
		self.__AnsiColorSet['MESSAGE_STATUS'] = AnsiColor(GetDefaultColor(4), "foreground")
		self.__AnsiColorSet['MESSAGE_STATUS_MESSAGE'] = AnsiColor(GetDefaultColor(3), "foreground")
		self.__AnsiColorSet['TYPE_MESSAGE'] = AnsiColor(GetDefaultColor(21), "foreground")
		self.__AnsiColorSet['MESSAGE_MESSAGE'] = AnsiColor(GetDefaultColor(23), "foreground")
		self.__AnsiColorSet['MESSAGE_BACKGROUND'] = ""

		self.__AnsiColorSet['INFO_TIME'] = AnsiColor(GetDefaultColor(8), "foreground")
		self.__AnsiColorSet['INFO_USER'] = AnsiColor(GetDefaultColor(7), "foreground")
		self.__AnsiColorSet['INFO_STATUS'] = AnsiColor(GetDefaultColor(4), "foreground")
		self.__AnsiColorSet['INFO_STATUS_MESSAGE'] = AnsiColor(GetDefaultColor(3), "foreground")
		self.__AnsiColorSet['TYPE_INFO'] = AnsiColor(GetDefaultColor(24), "foreground")
		self.__AnsiColorSet['INFO_MESSAGE'] = AnsiColor(GetDefaultColor(22), "foreground")
		self.__AnsiColorSet['INFO_BACKGROUND'] = ""

		self.__AnsiColorSet['NOTICE_TIME'] = AnsiColor(GetDefaultColor(8), "foreground")
		self.__AnsiColorSet['NOTICE_USER'] = AnsiColor(GetDefaultColor(7), "foreground")
		self.__AnsiColorSet['NOTICE_STATUS'] = AnsiColor(GetDefaultColor(4), "foreground")
		self.__AnsiColorSet['NOTICE_STATUS_MESSAGE'] = AnsiColor(GetDefaultColor(3), "foreground")
		self.__AnsiColorSet['TYPE_NOTICE'] = AnsiColor(GetDefaultColor(26), "foreground")
		self.__AnsiColorSet['NOTICE_MESSAGE'] = AnsiColor(GetDefaultColor(25), "foreground")
		self.__AnsiColorSet['NOTICE_BACKGROUND'] = ""

		self.__AnsiColorSet['WARNING_TIME'] = AnsiColor(GetDefaultColor(8), "foreground")
		self.__AnsiColorSet['WARNING_USER'] = AnsiColor(GetDefaultColor(7), "foreground")
		self.__AnsiColorSet['WARNING_STATUS'] = AnsiColor(GetDefaultColor(4), "foreground")
		self.__AnsiColorSet['WARNING_STATUS_MESSAGE'] = AnsiColor(GetDefaultColor(3), "foreground")
		self.__AnsiColorSet['TYPE_WARNING'] = AnsiColor(GetDefaultColor(34), "foreground")
		self.__AnsiColorSet['WARNING_MESSAGE'] = AnsiColor(GetDefaultColor(33), "foreground")
		self.__AnsiColorSet['WARNING_BACKGROUND'] = AnsiColor(GetDefaultColor(6), "background")

		self.__AnsiColorSet['ERROR_TIME'] = AnsiColor(GetDefaultColor(8), "foreground")
		self.__AnsiColorSet['ERROR_USER'] = AnsiColor(GetDefaultColor(7), "foreground")
		self.__AnsiColorSet['ERROR_STATUS'] = AnsiColor(GetDefaultColor(4), "foreground")
		self.__AnsiColorSet['ERROR_STATUS_MESSAGE'] = AnsiColor(GetDefaultColor(3), "foreground")
		self.__AnsiColorSet['TYPE_ERROR'] = AnsiColor(GetDefaultColor(33), "foreground")
		self.__AnsiColorSet['ERROR_MESSAGE'] = AnsiColor(GetDefaultColor(33), "foreground")
		self.__AnsiColorSet['ERROR_BACKGROUND'] = AnsiColor(GetDefaultColor(2), "background")

		self.__AnsiColorSet['CRITICAL_TIME'] = AnsiColor(GetDefaultColor(8), "foreground")
		self.__AnsiColorSet['CRITICAL_USER'] = AnsiColor(GetDefaultColor(7), "foreground")
		self.__AnsiColorSet['CRITICAL_STATUS'] = AnsiColor(GetDefaultColor(4), "foreground")
		self.__AnsiColorSet['CRITICAL_STATUS_MESSAGE'] = AnsiColor(GetDefaultColor(3), "foreground")
		self.__AnsiColorSet['TYPE_CRITICAL'] = AnsiColor(GetDefaultColor(33), "foreground")
		self.__AnsiColorSet['CRITICAL_MESSAGE'] = AnsiColor(GetDefaultColor(33), "foreground")
		self.__AnsiColorSet['CRITICAL_BACKGROUND'] = AnsiColor(GetDefaultColor(0), "background")

		self.__AnsiColorSet['PROGRESS_TIME'] = AnsiColor(GetDefaultColor(8), "foreground")
		self.__AnsiColorSet['PROGRESS_USER'] = AnsiColor(GetDefaultColor(7), "foreground")
		self.__AnsiColorSet['PROGRESS_STATUS'] = AnsiColor(GetDefaultColor(4), "foreground")
		self.__AnsiColorSet['PROGRESS_STATUS_MESSAGE'] = AnsiColor(GetDefaultColor(3), "foreground")
		self.__AnsiColorSet['TYPE_PROGRESS'] = AnsiColor(GetDefaultColor(33), "foreground")
		self.__AnsiColorSet['PROGRESS_MESSAGE'] = AnsiColor(GetDefaultColor(34), "foreground")
		self.__AnsiColorSet['PROGRESS_BACKGROUND'] = AnsiColor(GetDefaultColor(20), "background")

		self.__AnsiColorSet['SUCCESS_TIME'] = AnsiColor(GetDefaultColor(8), "foreground")
		self.__AnsiColorSet['SUCCESS_USER'] = AnsiColor(GetDefaultColor(7), "foreground")
		self.__AnsiColorSet['SUCCESS_STATUS'] = AnsiColor(GetDefaultColor(4), "foreground")
		self.__AnsiColorSet['SUCCESS_STATUS_MESSAGE'] = AnsiColor(GetDefaultColor(3), "foreground")
		self.__AnsiColorSet['TYPE_SUCCESS'] = AnsiColor(GetDefaultColor(33), "foreground")
		self.__AnsiColorSet['SUCCESS_MESSAGE'] = AnsiColor(GetDefaultColor(33), "foreground")
		self.__AnsiColorSet['SUCCESS_BACKGROUND'] = AnsiColor(GetDefaultColor(9), "background")

		self.__AnsiColorSet['FAIL_TIME'] = AnsiColor(GetDefaultColor(8), "foreground")
		self.__AnsiColorSet['FAIL_USER'] = AnsiColor(GetDefaultColor(7), "foreground")
		self.__AnsiColorSet['FAIL_STATUS'] = AnsiColor(GetDefaultColor(4), "foreground")
		self.__AnsiColorSet['FAIL_STATUS_MESSAGE'] = AnsiColor(GetDefaultColor(3), "foreground")
		self.__AnsiColorSet['TYPE_FAIL'] = AnsiColor(GetDefaultColor(33), "foreground")
		self.__AnsiColorSet['FAIL_MESSAGE'] = AnsiColor(GetDefaultColor(33), "foreground")
		self.__AnsiColorSet['FAIL_BACKGROUND'] = AnsiColor(GetDefaultColor(1), "background")
